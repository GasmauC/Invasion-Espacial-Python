...
funte_final = pygame.font.Font('freesansbold.ttf',40)

def texto_final():
    mi_fuente_final = funte_final.render("JUEGO TERMINADO",True, (255,255,255))
...
while se_ejecuta:
    ...
    # modificacion ubicacion del jugador  
    ...
    if jugador_x <= 0:
     ...
     # modificacion ubicacion del enemigo
    for e in range(cantidad_enemigos):
